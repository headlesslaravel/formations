    ...
    protected function applySort($query)
    {
        ...
        if (! empty($sortable['relationship'])) {
            ...
            if ($relation instanceof BelongsTo || $relation instanceof MorphTo) {
                ...
                || $relation instanceof HasOne || $relation instanceof HasOneOrMany || $relation instanceof HasOneThrough
                || $relation instanceof MorphMany || $relation instanceof MorphOne || $relation instanceof MorphOneOrMany
                || $relation instanceof MorphToMany) {
                $localKey = $relation->getLocalKeyName();
            } else if ($relation instanceof BelongsToMany) {
                $localKey = $relation->getRelatedKeyName();
            } else if ($relation instanceof MorphPivot || $relation instanceof Pivot) {
                $localKey = $relation->getRelatedKey();
            }
            
            $query->addSelect([
                $relation->getModel()->getTable().'.'.$localKey, // comments.id
